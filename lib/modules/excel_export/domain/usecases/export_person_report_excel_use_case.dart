...
import '../../templates/person_report_excel_template.dart';
import '../models/excel_export_result.dart';

/// Generates and exports the person report Excel workbook.
class ExportPersonReportExcelUseCase {
  /// Creates [ExportPersonReportExcelUseCase].
  const ExportPersonReportExcelUseCase(
  ...
  final PersonReportExcelTemplate _template;
