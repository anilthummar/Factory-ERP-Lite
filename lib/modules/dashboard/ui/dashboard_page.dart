...
import 'dashboard_activity_source_ui.dart';
import 'widget/dashboard_summary_card.dart';
import '../../factory_status/mapper/factory_status_ui_mapper.dart';

/// Dashboard tab — live factory overview and summary metrics.
class DashboardTabPage extends StatelessWidget {
  ...
  /// When true, the tab is visible in the main shell and may refresh data.
  final bool isActive;
  ...
  Widget build(BuildContext context) {
    return BlocProvider<DashboardBloc>(
      ...
      child: _DashboardTabView(isActive: isActive),
    );
  }
}

class _DashboardTabView extends StatefulWidget {
  const _DashboardTabView({required this.isActive});
...
class _DashboardTabViewState extends State<_DashboardTabView> {
  @override
  void didUpdateWidget(covariant _DashboardTabView oldWidget) {
  ...
  Widget _buildBody(BuildContext context, DashboardState state) {
    ...
    final String factoryStatusNotes = data?.currentFactoryStatusNotes
                ?.isNotEmpty ??
            false
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        if (data?.factoryStatusUpdatedAt != null) ...<Widget>[
                          const SizedBox(height: Dimens.space8),
                          CustomTextLabelWidget(
                            label:
                                '${strings.lastUpdatedKey}: ${dateToString(
                              data!.factoryStatusUpdatedAt!,
                              dateFormat: DateConstants.dateTimeFormat,
                            )}',
                            textAlign: TextAlign.start,
                            style:
                        ...
                        CustomTextLabelWidget(
                          label: factoryStatusNotes,
                          textAlign: TextAlign.start,
                          style:
                              AppStyles.instance.textTheme.bodySmall?.copyWith(
                            color: colorScheme.onSurfaceVariant,
                          ),
                        ),
                      ],
                  ...
                  child: SizedBox(
                    ...
                    child: Padding(
                      ...
                      child: CustomTextLabelWidget(
                        ...
                        style:
                            AppStyles.instance.textTheme.bodyMedium?.copyWith(
                          color: colorScheme.onSurfaceVariant,
                        ),
                      ),
                    ),
