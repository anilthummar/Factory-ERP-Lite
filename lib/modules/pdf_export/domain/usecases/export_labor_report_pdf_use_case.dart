...
import '../../templates/labor_report_pdf_template.dart';
import '../models/pdf_export_result.dart';
import '../models/report_data_snapshot.dart';

/// Generates and exports the labor report PDF.
class ExportLaborReportPdfUseCase {
  /// Creates [ExportLaborReportPdfUseCase].
  const ExportLaborReportPdfUseCase(
  ...
  final LaborReportPdfTemplate _template;
